def build_model(args_dict):
    ...
    from models import modify_waveflow as waveflow
...
def build_model_flowpp(args_dict):
    # from models import waveflow
    from models import flowpp_waveflow as waveflow
...
def build_model_nano_flowpp(args_dict):
    # from models import waveflow
    from models import nano_flowpp as waveflow
